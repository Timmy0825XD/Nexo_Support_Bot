...
Tabla de control de los archivos en `docs/`. Cada documento cumple un rol específico; consultar el indicado según lo que necesites.

| Archivo | Para qué sirve | Cuándo consultarlo |
|---|---|---|
| [`index.md`](./index.md) | Índice y mapa de toda la documentación del proyecto | Cuando no sepas qué archivo leer |
| [`CONTEXT.md`](./CONTEXT.md) | Contexto del producto, arquitectura, alcance, stack, roadmap y glosario | Para entender qué es la plataforma y cómo está diseñada |
